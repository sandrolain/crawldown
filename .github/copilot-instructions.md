...
This is a golang project for web crawling and full website downloading with content conversion to markdown.
...
- run `golangci-lint run ./src/...` and `govulncheck ./...` to ensure no issues are present.
- update TODO.md file marking completed tasks.
